    ...
    <div className="min-h-screen gradient-feminine">
      ...
      <div className="bg-white rounded-xl shadow-2xl p-8 max-w-2xl w-full mx-4 text-center">
        ...
        <p className="text-gray-600 mb-8">
          Obrigado por sua compra! Seu pagamento foi aprovado e seu acesso ao Kit Essencial foi liberado.
        </p>
        
        
        <div className="space-y-4">
          <a 
            href="https://drive.google.com/drive/folders/1_UFdNBFTTb8WNucLI7wqkw_efr-EYIN_?usp=sharing" 
            target="_blank" 
